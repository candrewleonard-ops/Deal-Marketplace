      ...
      <div style={{
        ...
        {!isLoggedIn ? (
          <div style={{ padding: '32px 24px', textAlign: 'center' }}>
            <Shield size={40} style={{ color: '#8b5cf6', marginBottom: '16px' }} />
            <h3 style={{ color: '#f8fafc', fontWeight: 700, fontSize: '18px', marginBottom: '8px' }}>Sign up or Log in to request address</h3>
            <p style={{ color: '#94a3b8', fontSize: '14px', marginBottom: '24px' }}>You need to be logged in to request property details.</p>
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
              ...
              <Link to="/auth" style={{ padding: '12px 24px', borderRadius: '10px', color: '#94a3b8', textDecoration: 'none', border: '1px solid #1e1e2e', background: 'rgba(255,255,255,0.05)', fontWeight: 600 }}>Log In</Link>
            </div>
          </div>
        ) : (
          <div style={{ padding: '24px' }}>
            ...
            <label style={{
              ...
              background: '#1a1a2e', border: `1px solid ${agreed ? '#8b5cf6' : '#1e1e2e'}`,
            ...
            <button
              ...
              style={{
                ...
                border: agreed ? 'none' : '1px solid #1e1e2e',
