    ...
    <div style={{ background: '#0a0a0f', minHeight: '100vh', paddingBottom: '60px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {invites.length === 0 && (
              <div style={{ textAlign: 'center', padding: '60px 20px', background: '#12121e', border: '1px solid #1e1e2e', borderRadius: '16px' }}>
                <Users size={48} style={{ color: '#8b5cf6', marginBottom: '16px', opacity: 0.4 }} />
                <h3 style={{ color: '#f8fafc', fontWeight: 700, marginBottom: '8px' }}>No pending invites</h3>
                <p style={{ color: '#475569', fontSize: '14px' }}>When someone invites you to a group, it'll show up here</p>
              </div>
            )}
            {invites.map((inv, i) => {
              ...
              return (
                <div key={i} style={{ background: '#12121e', border: '1px solid #1e1e2e', borderRadius: '12px', padding: '16px', display: 'flex', alignItems: 'center', gap: '14px' }}>
                  ...
                  <button
                    ...
                    style={{ padding: '8px 14px', borderRadius: '8px', background: 'linear-gradient(135deg, #8b5cf6, #06b6d4)', border: 'none', color: '#fff', fontWeight: 700, fontSize: '13px', cursor: 'pointer' }}
                  >
          ...
          <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '16px' }}>
              {currentList.map(g => {
                ...
                return (
                  <div key={g.id} style={{ background: '#12121e', border: '1px solid #1e1e2e', borderRadius: '12px', overflow: 'hidden', transition: 'transform 0.2s, box-shadow 0.2s' }}
                  ...
                  >
                    ...
                    <div style={{ padding: '14px' }}>
                      ...
                      <div style={{ color: '#475569', fontSize: '11px', fontWeight: 600, marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{g.category}</div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        {activeTab === 'mine' ? (
                          ...
                          <button
                            ...
                            style={{ padding: '6px 12px', borderRadius: '8px', background: 'linear-gradient(135deg, #8b5cf6, #06b6d4)', border: 'none', color: '#fff', fontWeight: 700, fontSize: '12px', cursor: 'pointer' }}
                          >
      ...
      {showCreate && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 300, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowCreate(false)}>
          <div onClick={e => e.stopPropagation()} style={{ background: '#12121e', border: '1px solid #1e1e2e', borderRadius: '20px', width: '100%', maxWidth: '500px' }}>
            ...
            <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <label style={{ display: 'flex', gap: '10px', cursor: 'pointer', padding: '12px', background: '#1a1a2e', borderRadius: '8px', border: '1px solid #1e1e2e' }}>
                <input
                  type="checkbox"
                ...
                <div>
                  ...
                  <div style={{ color: '#475569', fontSize: '12px', marginTop: '2px' }}>Members must be approved to join. Great for deal-sharing networks.</div>
                </div>
              </label>
              <div style={{ display: 'flex', gap: '10px' }}>
                <button onClick={() => setShowCreate(false)} style={{ flex: 1, padding: '12px', borderRadius: '10px', background: 'rgba(255,255,255,0.05)', border: '1px solid #1e1e2e', color: '#94a3b8', cursor: 'pointer', fontWeight: 600 }}>
                  Cancel
                </button>
                <button
